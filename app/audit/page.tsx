        ...
        {showRobot && (
          <div className="animate-in zoom-in fade-in duration-700 space-y-6">
            <div className="p-6 bg-blue-600/10 border border-blue-500/20 rounded-2xl italic text-lg leading-relaxed">
                "What are you waiting for? You have the Ultimate AI Board of Directors at your finger tips! ACT NOW! Our highly trained agents are ready to put you on the path to success. Stop Dreaming and Start Launching!"
            </div>
